...
var lanternfish_scene = load("res://scenes/enemies/lantern_fish.tscn")
...
func _ready() -> void:
	...
	$lanternfish_spawner.fish_scene = lanternfish_scene
	$lanternfish_spawner.player = $player
	...
	for i in range(15):
		$lanternfish_spawner.spawn_fish()
